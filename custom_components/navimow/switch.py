...
class NavimowSwitch(SwitchEntity):
    ...
    def is_on(self) -> bool | None:
        ...
        value = attrs.attributes.get(attr_key)
    ...
    async def _set_attribute(self, key: str, value: bool) -> None:
        ...
        try:
            await self.api.async_set_device_attribute(self.coordinator.device.id, key, value)
        except Exception as err:
            import logging
            logging.getLogger(__name__).error(f"Failed to set {key}: {err}")